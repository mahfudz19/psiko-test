...
<section class="bulk-scores-section">
    <article class="bulk-scores-card">
        ...
        <form action="/admin/students/bulk-scores" method="POST" enctype="multipart/form-data" class="bulk-scores-form">
            <?= csrf_field() ?>
            ...
            <div class="bulk-scores-actions">
                ...
                <a href="/admin/students" class="bulk-scores-btn bulk-scores-btn-secondary">
                    ← Batal
                </a>
            </div>
        </form>
...
0012345679,Semester 1 Kelas 10,IPA,95,93,97</pre>
        ...
        <div class="bulk-scores-download">
            <a href="/admin/students/bulk-scores/template" class="bulk-scores-btn bulk-scores-btn-outline" download>
