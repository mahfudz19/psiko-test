...
/**
 * Halaman bulk import siswa untuk School Admin (admin/teacher)
 * School ID di-deteksi dari session, tidak perlu parameter
 */
?>
...
<div class="bulk-import-page">
    <div class="page-header">
        <div>
            <a data-spa href="/admin/students" class="back-link">
                ← Kembali ke Daftar Siswa
            </a>
            <h1>📥 Import Banyak Siswa</h1>
            <p class="page-description">Upload file CSV untuk menambahkan banyak siswa sekaligus ke sekolah Anda</p>
        </div>
    </div>
    ...
    <div class="import-steps">
        ...
        <div class="step">
            ...
            <form data-spa action="/admin/students/bulk-create" method="POST" enctype="multipart/form-data" class="upload-form">
